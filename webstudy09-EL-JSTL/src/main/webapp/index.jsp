...
<body>
<h2>Model2 MVC 기반의 EL 과 JSTL Study</h2>
<%--
...
<a href="Test05Servlet?address=런던">JSTL forEach Test5</a><br><br>
<%-- 
	index.jsp --- Controller인 Test05Servlet --- MemberDao
					  address를 사용자로부터 받아와서
					  Model 연동 후 Member List를 반환받는다
					  반환받은 list를 request 영역에 공유한다
					  forward로 이동시킨다 step5-jstl-forEach-member-list jsp로
					  제어를 이동하여 응답한다
--%>
